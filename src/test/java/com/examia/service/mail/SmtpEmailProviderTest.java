...
class SmtpEmailProviderTest {
    ...
    @BeforeEach
    void setUp() {
        ReflectionTestUtils.setField(provider, "mailFrom", "noreply@examia.com");
    }

    @Test
    void send_buildsCorrectSimpleMailMessage() {
        doNothing().when(mailSender).send(any(SimpleMailMessage.class));

        provider.send("recipient@example.com", "Test Subject", "Test Body");
